                        ...
                        state.cartItems.map(item => (
                            <li key={item.id} className="cart-items">
                                ...
                                <div className="prod-desc">
                                    ...
                                    <button onClick={() => {removeItem(item._id); notify("r");}} className="remove-btn">Remove from cart</button>
                                    <button onClick={() => {removeItem(item._id);handleWishlist(item); notify("m")}} disabled={foundWL(item.title)} className="wl-btn">{foundWL(item.title) ? "Added to wishlist" : "Move to wishlist"}</button>
                                </div>
